...
const Projects = () => {
  ...
  const springX= useSpring(x, {damping:10, stiffness: 50}); //adds a springy effect 
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-trnsparent via-neutral-700 to-transparent mt-12 h-[1px] w-full"/>
